<div class="bg-primary w-full py-16">
    <h1 class="font-medium text-2xl text-white text-center mb-10 max-w-xl mx-auto">Together with Our Amazing Clients, We Build Digital Solutions That Make a Difference</h1>
