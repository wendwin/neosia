...
{{-- <div class="bg-slate-100 w-full min-h-screen my-2">
    <div class="flex gap-2 items-center justify-center">
        <div class="bg-sec-grey text-sec-gray2 h-10 p-4 flex items-center justify-start max-w-2xl w-full rounded-md">
            <form action="" class="flex items-center gap-2 w-full">
                <ion-icon name="search-outline"></ion-icon>
                <input type="text" name="" id="" placeholder="Search for course"
                    class="w-full bg-sec-grey">
            </form>
        </div>
    ...
    <div class="w-full p-5 md:flex justify-around items-center container mx-auto my-14 ">
        <div class="flex justify-center items-end mb-10 md:order-2">
            <img src="{{ asset('img/hero.png') }}" alt="hero" class="">
        </div>
        <div class="text-sec-white md:order-1">
            <h1 class="text-3xl lg:text-5xl text-white font-bold leading-10 mb-6 max-w-2xl">
                Unlock Your Potential with <span class="text-sec-yellow">Neosia Training Center</span>
            </h1>
            <p class="text-sec-gray2 max-w-lg mb-8">
            ...
            <div class="px-4 py-2 bg-amber-400 rounded-md w-fit">
                <p class="text-base text-primary">Explore Now</p>
            </div>
        </div>
    </div>
</div> --}}
